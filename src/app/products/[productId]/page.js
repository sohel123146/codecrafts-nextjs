        ...
        <div className="container px-5 py-10 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="pin flex items-center space-x-2 mt-5">
                <input
                  onChange={onChange}
                  className="mr-2 py-2 px-1 border border-black rounded-md text-sm"
                  type="text"
                />
                <button
                  onClick={checkServiceAvailability}
                  className=" mr-2 ml-14 text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  Check Availability
                </button>
              </div>
              <div className="msg mt-2 p-2 text-sm">
                {!service && service != null && <div className="text-red-600">Sorry! service not available yet</div>}

                {service && service != null && <div className="text-green-600">Yay! service available</div>}
              </div>
            </div>
          </div>
        </div>
